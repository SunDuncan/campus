...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 字典管理 <span class="c-gray en">&gt;</span> 字典查询 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<table class="table">
    <tr>
        <td width="200" class="va-t"><ul id="treeDemoList" class="ztree"></ul></td>
        <td class="va-t"><iframe ID="testIframeList" Name="testIframeList" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="showlist.html"></iframe></td>
    </tr>
</table>
...
<script type="text/javascript">
    ...
    var zNodes =[
        ...
        { id:12, pId:1, name:"生活"},
        { id:121, pId:12, name:"快递代拿"},
        { id:122, pId:12, name:"午饭代拿"},
    ];
