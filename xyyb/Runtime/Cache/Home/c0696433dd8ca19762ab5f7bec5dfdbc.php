...
<script type="text/javascript" src="<?php echo (HUI_ADMIN_LIB); ?>jquery.validation/1.14.0/jquery.validate.js"></script>
<script type="text/javascript" src="<?php echo (HUI_ADMIN_LIB); ?>jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="<?php echo (HUI_ADMIN_LIB); ?>jquery.validation/1.14.0/messages_zh.js"></script>
